const featuredArticles = [
  {
    ...
    imageURL:
      "https://sm.ign.com/ign_il/news/h/halo-infin/halo-infinite-campaign-co-op-and-forge-mode-releases-pushed_stzr.jpg",
  },
  {
    id: 2,
    title: "The Witcher 4: What Can We Except",
    description:
      "The Witcher IV is an upcoming action role-playing game developed by CD Projekt Red and published by CD Projekt.",
    imageURL:
      "https://sm.ign.com/t/ign_il/blogroll/t/the-witche/the-witcher-3-the-wild-hunt-review_5vds.1280.jpg",
  },
  {
    id: 3,
